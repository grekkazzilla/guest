function getSay(root,wPage,hPage,blr){
    ...
    box.hPage=hPage;
    getText(null,box,10,30,20,'Arial','#000','none',0,'','start').style.fontWeight='bold';
    getText(null,box,10,65,20,'Arial','#000','none',0,'','start');
    getText(null,box,10,100,20,'Arial','#bdb76d','none',0,'','start');
    getText(null,box,10,120,20,'Arial','#bdb76d','none',0,'','start');
    getText(null,box,10,140,20,'Arial','#bdb76d','none',0,'','start');
